      ...
      <?php get_header('search'); ?>   
        ...
        <div class="l-container wrapper">
          ...
          <div class="p-archive-menu-main">
            <section class="p-archive-menu--product1">
              <img class="p-archive-menu__image" src="./img/cheseburger.jpg" alt="商品の写真" />
              <div class="p-archive-menu__textbox wrapper">
                <h3 class="p-archive-menu__title">見出しが入ります</h3>
            ...
            <section class="p-archive-menu--product2">
              <img class="p-archive-menu__image" src="./img/cheseburger.jpg" alt="商品の写真" />
              <div class="p-archive-menu__textbox wrapper">
                <h3 class="p-archive-menu__title">見出しが入ります</h3>
                <h4 class="p-archive-menu__sub-title">小見出しが入ります</h4>
            ...
            <section class="p-archive-menu--product3">
              <img class="p-archive-menu__image" src="./img/cheseburger.jpg" alt="商品の写真" />
              <div class="p-archive-menu__textbox wrapper">
                <h3 class="p-archive-menu__title">見出しが入ります</h3>
                <h4 class="p-archive-menu__sub-title">小見出しが入ります</h4>
            ...
            <section class="p-archive-menu--product4">
              <img class="p-archive-menu__image" src="./img/cheseburger.jpg" alt="商品の写真" />
              <div class="p-archive-menu__textbox wrapper">
                <h3 class="p-archive-menu__title">見出しが入ります</h3>
                <h4 class="p-archive-menu__sub-title">小見出しが入ります</h4>
            ...
            <section class="p-archive-menu--product5">
              <img class="p-archive-menu__image" src="./img/cheseburger.jpg" alt="商品の写真" />
              <div class="p-archive-menu__textbox wrapper">
                <h3 class="p-archive-menu__title">見出しが入ります</h3>
                <h4 class="p-archive-menu__sub-title">小見出しが入ります</h4>
